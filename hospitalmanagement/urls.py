...
from hospitalmanagement.settings import Template_ROOT
...
urlpatterns +=[
    ...
    path('searchdoctor', views.search_doctor_view,name='searchdoctor'),
    path('patient-discharge', views.patient_discharge_view,name='patient-discharge'),
    path('patient-update-view/<str:firstname>', views.patient_update_view,name='patient-update-view'),
]

# must be at the end of file !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
urlpatterns +=[
    re_path(r'^(?P<path>.*)$', serve, {'document_root': Template_ROOT}),
]